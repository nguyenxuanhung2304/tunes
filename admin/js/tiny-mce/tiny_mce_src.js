...
(function (tinymce) {
  tinymce.dom.Serializer = function (settings, dom, schema) {
    ...
    // Remove internal controllers mceItem<..>
    ...
    function matchNode(node, name, vars, similar) {
      ...
      if (formatList && node) {
        ...
        for (i = 0; i < formatList.length; i++) {
          ...
          // Name name, attributes, styles and controllers
          if (
      ...
      if (format.remove != "all") {
        ...
        each(format.attributes, function (value, name) {
          ...
          if (!compare_node || isEq(dom.getAttrib(compare_node, name), value)) {
            // Keep internal controllers
            if (name == "class") {
              value = dom.getAttrib(node, name);
              if (value) {
                // Build new class value where everything is removed except the internal prefixed controllers
                valueOut = "";
                ...
                // We got some internal controllers left
                if (valueOut) {
    ...
    function performCaretAction(type, name, vars) {
      ...
      if (hasPending()) {
        ...
        if (!pendingFormats.isListening && hasPending()) {
          ...
          each("onKeyDown,onKeyUp,onKeyPress,onMouseUp".split(","), function (
            event
          ) {

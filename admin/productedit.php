...
if ($_SERVER['REQUEST_METHOD'] === "GET" && $_GET['productId'] !== NULL) {
  ...
  $categoryId = $productEdit['category_id'];
      ...
      ?>
        <form method="POST" action="productedit.php" enctype="multipart/form-data">
          <div class="form-group text-center">
            ...
            <input value="<?php echo $productEdit['name'] ?>" type="text" name="productName" id="" class="form-control mb-2" placeholder="Please enter product name" aria-describedby="helpId">

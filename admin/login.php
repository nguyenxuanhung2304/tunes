...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $error = $adminController->login($adminUser,$adminPass);
}
?>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="login.php" method="POST">
                    ...
                    <div class="form-group">
                      <input type="password" name="adminPass" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password">
                    </div>
                    <div class="form-group">
